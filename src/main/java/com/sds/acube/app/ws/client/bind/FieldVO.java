...
/**
 * <p>FieldVO complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="FieldVO">
 *   &lt;complexContent>
...
@XmlType(name = "FieldVO", propOrder = {
    "field",
    "image",
    "sign",
    "signType",
...
public class FieldVO {
    ...
    @XmlElement(name = "Sign", nillable = true)
    protected String sign;
    @XmlElement(name = "SignType")
    protected Integer signType;
    @XmlElement(name = "UserUid", nillable = true)
