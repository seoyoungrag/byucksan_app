...
public class UserImageTableMap extends TableMap
{
	// User Image Table Map
	public static final int USER_ID = 0;
	public static final int PICTURE = 1;
	public static final int STAMP = 2;
	public static final int SIGN = 3;
	public static final int PICTURE_TYPE = 4;
	public static final int STAMP_TYPE = 5;
	public static final int SIGN_TYPE = 6;
	public static final int STAMP_OR_SIGN = 7;
