...
public class DutyTableMap extends TableMap
{
	// Duty Table Map
	public static final int DUTY_ID = 0;
	public static final int DUTY_NAME = 1;
	public static final int DUTY_OTHER_NAME = 2;
	public static final int DUTY_PARENT_ID = 3;
	public static final int COMP_ID = 4;
	public static final int DUTY_ORDER = 5;
