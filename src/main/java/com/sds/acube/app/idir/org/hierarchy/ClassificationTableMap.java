...
public class ClassificationTableMap extends TableMap
{	
	// Classification Table Map
	public static final int CLASSIFICATION_ID = 0;
	public static final int CLASSIFICATION_NAME= 1;
	public static final int RETENTION_DATE= 2;
	public static final int CLASSIFICATION_PARENT_ID= 3;
	public static final int COMP_ID= 4;
	public static final int DESCRIPTION= 5;
	public static final int CLASSIFICATION_CODE = 6;
