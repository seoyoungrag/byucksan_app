...
/**
 * <p>Java class for AppMenuVOs complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AppMenuVOs">
 *   &lt;complexContent>
 ...
 *         &lt;element name="appMenuVOs" type="{http://service.ws.app.acube.sds.com/}AppMenuVO" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "AppMenuVOs", propOrder = {
    "reqtype",
    "reqdate",
    "orgcode",
    "userid",
...
public class AppMenuVOs {
    ...
    protected List<AppMenuVO> appMenuVOs;
    ...
    /**
     * Gets the value of the appMenuVOs property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the appMenuVOs property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAppMenuVOs().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<AppMenuVO> getAppMenuVOs() {
        if (appMenuVOs == null) {
            appMenuVOs = new ArrayList<AppMenuVO>();
        }
