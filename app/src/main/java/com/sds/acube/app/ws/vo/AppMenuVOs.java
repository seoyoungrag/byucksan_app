...
/**
 * Class Name  : AppMenuVOs.java <br> Description : 설명  <br> Modification Information <br> <br> 수 정  일 : 2011. 5. 23. <br> 수 정  자 : chamchi  <br> 수정내용 :  <br>
 * @author   chamchi 
 * @since  2011. 5. 23.
 * @version  1.0 
 * @see  com.sds.acube.app.ws.vo.AppMenuVOs.java
 */
...
public class AppMenuVOs {
    ...
    private List<AppMenuVO> appMenuVOs;
    
    

    /**
	 * @return  the appMenuVOs
	 */
    ...
    /**
	 * @param appMenuVOs  the appMenuVOs to set
	 */
    public void setAppMenuVOs(List<AppMenuVO> appMenuVOs) {
        this.appMenuVOs = appMenuVOs;
    }
