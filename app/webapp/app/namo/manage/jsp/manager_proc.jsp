...
<%
	...
	if(check){
		result_sc = "<script type='text/javascript' language='javascript'>alert(ce_bk.ce_lY); window.document.location.href='manager_setting.jsp?Tab=" + request.getParameter("Tab") + "';</script>";
	}
	else{
