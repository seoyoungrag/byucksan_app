...
function printList(strPrintType, strSearchItem, strSearchValue, strIsSearchMode)
{
	...
	var strUrl = g_strBaseUrl + "list/print/CN_TransferDocflowPrintListForAnam.jsp?userid=" + escape(g_strUserID)
	...
	window.open(strUrl, "CN_TransferDocflowPrintList","toolbar=no, scrollbars=yes, resizable=yes, status=yes, width=800,height=600");
}
...
function onSearch()
{
	...
	var strFolderList = eleDataInfo.getAttribute("folderlist");
	var strTitle = eleDataInfo.getAttribute("title");
	var strTargetPage = "CN_TransferDocflowListForAnam.jsp";
...
function changeListing(strListing)
{
	...
	var strUrl = "CN_TransferDocflowListForAnam.jsp?userid=" + escape(g_strUserID) + "&deptid=" + escape(g_strDeptID) + "&folderlist=" + strFolderList + "&title=" + strTitle + "&curpage=" + strCurPage + "&listing=" + strListing;
	document.location.href = strUrl;
}
...
function changeSearchYear(strYear)
{
	...
	var strUrl = "CN_TransferDocflowListForAnam.jsp?userid=" + escape(g_strUserID) + "&deptid=" + escape(g_strDeptID) + "&folderlist=" + strFolderList + "&title=" + strTitle + "&curpage=" + strCurPage + "&listing=TOTAL" + "&searchyear=" + strYear;
	document.location.href = strUrl;
}
