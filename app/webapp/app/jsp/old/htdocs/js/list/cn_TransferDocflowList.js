...
function printList(strPrintType, strSearchItem, strSearchValue, strIsSearchMode)
{
	...
	var strUrl = g_strBaseUrl + "list/print/CN_TransferDocflowPrintList.jsp?userid=" + escape(g_strUserID)
...
function changeListing(strListing)
{
	...
	var strUrl = "CN_TransferDocflowList.jsp?userid=" + escape(g_strUserID) + "&deptid=" + escape(g_strDeptID) + "&folderlist=" + strFolderList + "&title=" + strTitle + "&curpage=" + strCurPage + "&listing=" + strListing;
	document.location.href = strUrl;
}
...
function changeSearchYear(strYear)
{
	...
	var strUrl = "CN_TransferDocflowList.jsp?userid=" + escape(g_strUserID) + "&deptid=" + escape(g_strDeptID) + "&folderlist=" + strFolderList + "&title=" + strTitle + "&curpage=" + strCurPage + "&listing=TOTAL" + "&searchyear=" + strYear;
	document.location.href = strUrl;
}
