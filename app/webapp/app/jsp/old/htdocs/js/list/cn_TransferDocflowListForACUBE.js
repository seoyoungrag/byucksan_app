...
//		window.open(strUrl,'Docflow_RegiDoc','toolbar=no,resizable=no, status=yes,width=620,height=620,top=0,left=0');
	...
	else
	{
		...
		var strUrl = g_strBaseUrl + "approve/document/CN_ApproveDocument.jsp?dataurl=" + escape(strDataUrl) + "&cabinet=" + escape(strCabinet) + "&docstatus=" + escape(nDocStatus) + "&linename=" + escape(strLineName) + "&serialorder=" + nSerialOrder + "&bodytype=" + escape(strBodyType) + "&edittype=51&transyear=" + escape(g_strSearchYear);
...
function onViewDocDetailInfo()
{
	if (checkSelectedItems())
	{
		...
		if (strCabinet == TRANSFER_LEDGER_REGI_REAL)
		{
			strCabinet = strCabinet.substr(1);
			var strUrl = g_strBaseUrl + "approve/dialog/CN_ApproveDocDetail.jsp?dataurl=" + escape(strDataUrl) + "&cabinet=" + escape(strCabinet) + "&docstatus=" + escape(nDocStatus) + "&linename=" + escape(strLineName) + "&serialorder=" + escape(nSerialOrder) + "&edittype=51&transyear=" + g_strSearchYear;
		...
		{
			strCabinet = strCabinet.substr(1);
			var strUrl = g_strBaseUrl + "approve/dialog/CN_ApproveDocDetail.jsp?recv=RECV&dataurl=" + escape(strDataUrl) + "&cabinet=" + escape(strCabinet) + "&docstatus=" + escape(nDocStatus) + "&linename=" + escape(strLineName) + "&serialorder=" + escape(nSerialOrder) + "&edittype=51&transyear=" + g_strSearchYear;
			window.open(strUrl,"CN_ApproveDocDetail","toolbar=no,resizable=no, status=yes, width=580,height=400");
		}
		...
		{
			strCabinet = strCabinet.substr(1);
			var strUrl = g_strBaseUrl + "approve/dialog/CN_ApproveDocDetail.jsp?ing=DIST&dataurl=" + escape(strDataUrl) + "&cabinet=" + escape(strCabinet) + "&docstatus=" + escape(nDocStatus) + "&linename=" + escape(strLineName) + "&serialorder=" + escape(nSerialOrder) + "&edittype=51&transyear=" + g_strSearchYear;
			window.open(strUrl,"CN_ApproveDocDetail","toolbar=no,resizable=no, status=yes, width=580,height=400");
		}
...
function printList(strPrintType, strSearchItem, strSearchValue, strIsSearchMode)
{
	...
	var strUrl = g_strBaseUrl + "list/print/CN_TransferDocflowPrintListForACUBE.jsp?userid=" + escape(g_strUserID)
	...
	window.open(strUrl, "CN_DocflowPrintListForACUBE","toolbar=no, scrollbars=yes, resizable=yes, status=yes, width=800,height=600");
}
...
function onSearch()
{
	...
	if (strFolderList == TRANSFER_LEDGER_REGI_REAL)
	{
		var strUrl = g_strBaseUrl + "list/search/CN_TRegiLedgerSearch.jsp?title=" + strTitle + "&cabinet=" + strFolderList;
		window.open(strUrl, "CN_TRegiLedgerSearch", "toolbar=no, resizable=no, status=yes, width=420,height=260,top=0,left=0");
	}
	else if (strFolderList == TRANSFER_LEDGER_RECV_REAL)
	{
		var strUrl = g_strBaseUrl + "list/search/CN_TRecvLedgerSearch.jsp?title=" + strTitle + "&cabinet=" + strFolderList;
		window.open(strUrl, "CN_TRecvLedgerSearch", "toolbar=no, resizable=no, status=yes, width=420,height=230,top=0,left=0");
	}
	else if (strFolderList == TRANSFER_LEDGER_DIST_REAL)
	{
		var strUrl = g_strBaseUrl + "list/search/CN_TDistLedgerSearch.jsp?title=" + strTitle + "&cabinet=" + strFolderList;
		window.open(strUrl, "CN_TDistLedgerSearch", "toolbar=no, resizable=no, status=yes, width=420,height=200,top=0,left=0");
	}
	else if (strFolderList == TRANSFER_LEDGER_INSPECTION_REAL)
	{
		var strUrl = g_strBaseUrl + "list/search/CN_TInspLedgerSearch.jsp?title=" + strTitle + "&cabinet=" + strFolderList;
		window.open(strUrl, "CN_TDistLedgerSearch", "toolbar=no, resizable=no, status=yes, width=420,height=200,top=0,left=0");
	}
	else if (strFolderList == TRANSFER_LEDGER_TRANSFER_REAL)
	{
		var strUrl = g_strBaseUrl + "list/search/CN_TTransferLedgerSearch.jsp?title=" + strTitle + "&cabinet=" + strFolderList;
		window.open(strUrl, "CN_TDistLedgerSearch", "toolbar=no, resizable=no, status=yes, width=420,height=200,top=0,left=0");
	}
...
function changeListing(strListing)
{
	...
	var strUrl = "CN_TransferDocflowListForACUBE.jsp?userid=" + escape(g_strUserID) + "&deptid=" + escape(g_strDeptID) + "&folderlist=" + strFolderList + "&title=" + strTitle + "&curpage=" + strCurPage + "&listing=" + strListing;
	document.location.href = strUrl;
}
...
function changeSearchYear(strYear)
{
	...
	var strUrl = "CN_TransferDocflowListForACUBE.jsp?userid=" + escape(g_strUserID) + "&deptid=" + escape(g_strDeptID) + "&folderlist=" + strFolderList + "&title=" + strTitle + "&curpage=" + strCurPage + "&listing=TOTAL" + "&searchyear=" + strYear;
	document.location.href = strUrl;
}
...
function onClickSubject(listIndex, strFolderList, nDocStatus, strLineName, nSerialOrder, strBodyType, strIsSecurityDoc, strDocCategory, strIsPubDoc, strIsAdminMIS, nItemIndex, strYear)
{
	// 20030824, icaha
