...
<acube:outerFrame>
    ...
    try {
		    ...
		    titleRow.setAttribute(rowIndex, "style", "text-overflow : ellipsis; overflow : hidden;");
 		    ...
 		    titleRow.setData(++rowIndex, m.getMessage("bind.obj.doc.electronic", null, langType));
 		    titleRow.setAttribute(rowIndex, "style", "text-overflow : ellipsis; overflow : hidden;");
 		    ...
 		    if (rows.size() == 0) {
	 			...
	 			for (int i = 0; i < rows.size(); i++) {
	 			   ...
	 			   if(totalCount == 0) {
	 			    ...
	 			    row.setData(++rowIndex, "<img src=\"" + webUri + "/app/ref/image/" + ("DPI001".equals(vo.getDocType()) ? "icon_product_doc.gif" : "icon_receive_doc.gif") + "\">");
