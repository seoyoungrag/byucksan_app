...
<script language="javascript">
	function init() {
		$('#retentionPeriod').val('${vo.retentionPeriod}');
		$('#unitRefSavId').val('${vo.unitRefSavId}');
		$('#unitEviSavId').val('${vo.unitEviSavId}');
		$('#unitSavType').val('${vo.unitSavType}');
		$('#unitViewFreq').val('${vo.unitViewFreq}');
		$('#unitViewUse').val('${vo.unitViewUse}');
		$("input[name='unitWeight']:radio[value='${vo.unitWeight}']").attr('checked',true);
		$("input[name='unitSavPlace']:radio[value='${vo.unitSavPlace}']").attr('checked',true);
		$("input[name='unitProdBool']:radio[value='${vo.unitProdBool}']").attr('checked',true);
		
		<c:if test="${vo.unitSecBool=='Y'}">
		$('input:checkbox[id="unitSecBool"]').attr('checked', true);
		</c:if>
		 
		<c:forEach items="${addVos}" var="addvo">
		<c:choose> 
		  <c:when test='${addvo.unitAddOrder == "1"}' > 
		  $('#unit1stAdd').val('${addvo.unitAddName}');
		  $("input[name='unitAddType']:radio[value='${addvo.unitAddType}']").attr('checked',true);
		  </c:when> 
		  <c:when test='${addvo.unitAddOrder == "2"}' > 
		  $('#unit2ndAdd').val('${addvo.unitAddName}');
		  $("input[name='unitAddType']:radio[value='${addvo.unitAddType}']").attr('checked',true);
		  </c:when>
		  <c:when test='${addvo.unitAddOrder == "3"}' > 
		  $('#unit3stAdd').val('${addvo.unitAddName}');
		  $("input[name='unitAddType']:radio[value='${addvo.unitAddType}']").attr('checked',true);
		  </c:when>
		</c:choose>		  
		</c:forEach>
	...
	function edit() {
		...
		$.ajax({
			url : '<%=webUri%>/app/bind/unit/ex/update.do',
			type : 'POST',
			dataType : 'json',
			data : formData,
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<form id="form" method="POST" action="<%=webUri%>/app/bind/unit/create.do">
											...
											<input type="hidden" id="unitType" name="unitType" value="${vo.unitType}" />
											<input type="hidden" id="compId" name="compId" value="${vo.compId}" />
											...
											<tr bgcolor="#ffffff">
												...
												<td width="30%"><table width="100%" border="0" cellspacing="1" cellpadding="1">
														<tr bgcolor="#ffffff">
															<%--<td><input type="text" class="input" id="unitName" name="unitName" onclick="showResource(this, 'APP_BIND_UNIT', 'UNIT_NAME', '${vo.resourceId}','${vo.unitName}' )" readOnly style="width:100%" value="${vo.unitName}"></td> --%>
															<td><input type="text" class="input" id="unitName" name="unitName" style="width:100%" value="${vo.unitName}"></td>
														</tr>
													</table>
												</td>
												<!-- 단위업무코드 -->
												...
												<td width="30%"><table width="100%" border="0" cellspacing="1" cellpadding="1">
														<tr bgcolor="#ffffff">
															<td><input type="text" class="input_read" id="unitId" name="unitId" style="width:100%" maxLength="8" value="${vo.unitId}" readOnly></td>
														</tr>
													</table>
												</td>
											</tr>    
											...
											<tr bgcolor="#ffffff">
												...
												<td><table width="100%" border="0" cellspacing="1" cellpadding="1">
														<tr bgcolor="#ffffff">
															<td><input type="text" class="input" id="unitAlias" name="unitAlias" value="${vo.unitAlias}" readOnly style="width:100%" maxlength="40"></td>
														</tr>
													</table>
												</td>
												<!-- 비밀여부 -->
												...
												<td><table width="100%" border="0" cellspacing="1" cellpadding="1">
														<tr bgcolor="#ffffff">
															<td><input type="checkbox" id="unitSecBool" name="unitSecBool" value="${vo.unitSecBool}"/></td>
														</tr>
													</table>
												</td>
											</tr>  
											...
											<tr bgcolor="#ffffff"> 
												...
												<td colspan="3" height=68><table width="100%" border="0" cellspacing="1" cellpadding="1">
														<tr bgcolor="#ffffff">
															<td><textarea id="description" name="description" style="width:100%;overflow:auto" rows="5" onkeyup="checkInputMaxLength(this, '', 400)">${vo.description}</textarea></td>
														</tr>
													</table>
												</td>
											</tr> 
											...
											<tr bgcolor="#ffffff">
												...
												<td><table border="0" cellspacing="1" cellpadding="1">
													<tr>
														<td><form:select id="unitRefSavId" name="unitRefSavId" path="retentionPeriod" items="${retentionPeriod}" value="${vo.unitRefSavId}"/></td>
													</tr>
													</table>
												</td>
												<!-- 증빙자료 유효기간 -->
												...
												<td><table border="0" cellspacing="1" cellpadding="1">
													<tr>
														<td><form:select id="unitEviSavId" name="unitEviSavId" path="retentionPeriod" items="${retentionPeriod}" value="${vo.retentionPeriod}"/></td>
													</tr>
													</table>
												</td>
											</tr>
											...
											<tr bgcolor="#ffffff">
												...
												<td><table border="0" cellspacing="1" cellpadding="1">
														<tr bgcolor="#ffffff">
															<td><input type="text" class="input" id="unitDuty" name="unitDuty" style="width:30px;ime-mode:disabled;" onkeypress="return onlyNumber(event, false);" value="${vo.unitDuty}" maxlength="2"></td>
											...
											<tr bgcolor="#ffffff">
												...
												<td colspan="3"><table border="0" cellspacing="1" cellpadding="1">
													<tr>
														<td><form:select id="retentionPeriod" name="retentionPeriod" path="retentionPeriod" items="${retentionPeriod}" value="${vo.retentionPeriod}" /></td>
													</tr>
													</table>
												</td>
											</tr>
											...
											<tr bgcolor="#ffffff"> 
												...
												<td colspan="3" height=68><table width="100%" border="0" cellspacing="1" cellpadding="1">
														<tr bgcolor="#ffffff">
															<td><textarea id="retentionNote" name="retentionNote" style="width:100%;overflow:auto" rows="5" onkeyup="checkInputMaxLength(this, '', 400)">${vo.retentionNote}</textarea></td>
														</tr>
													</table>
												</td>
											</tr> 
											...
											<tr bgcolor="#ffffff">
												...
												<td><table border="0" cellspacing="1" cellpadding="1">
													<tr>
														<td><form:select id="unitSavType" name="unitSavType" path="unitSavType" items="${unitSavType}" value="${vo.unitSavType}"/></td>
													</tr>
													</table>
												</td>
												<!-- 보존장소 -->
											...
											<tr bgcolor="#ffffff">
												...
												<td><table border="0" cellspacing="1" cellpadding="1">
													<tr>
														<td><form:select id="unitViewFreq" name="unitViewFreq" path="unitViewFreq" items="${unitViewFreq}" value="${vo.unitViewFreq}"/></td>
													</tr>
													</table>
												</td>
												<!-- 주요열람 용도 -->
												...
												<td><table border="0" cellspacing="1" cellpadding="1">
													<tr>
														<td><form:select id="unitViewUse" name="unitViewUse" path="unitViewUse" items="${unitViewUse}" value="${vo.unitViewUse}"/></td>
													</tr>
													</table>
												</td>
											</tr>
											...
											<tr bgcolor="#ffffff">
												...
												<td colspan="3"><table width="100%" border="0" cellspacing="1" cellpadding="1">
														<tr bgcolor="#ffffff">
															<td><input type="text" class="input" id="unitProdTrans" name="unitProdTrans" style="width:100%" maxlength="100" value="${vo.unitProdTrans}" /></td>
														</tr>
													</table>
												</td>
											</tr>
											...
											<tr bgcolor="#ffffff">
												...
												<td colspan="3"><table width="100%" border="0" cellspacing="1" cellpadding="1">
														<tr bgcolor="#ffffff">
															<td><input type="text" class="input" id="unit2ndAdd" name="unit2stAdd" style="width:100%" maxlength="100" /></td>
														</tr>
													</table>
												</td>
											</tr>
											...
											<tr bgcolor="#ffffff">
												...
												<td colspan="3"><table width="100%" border="0" cellspacing="1" cellpadding="1">
														<tr bgcolor="#ffffff">
															<td><input type="text" class="input" id="unit3rdAdd" name="unit3stAdd" style="width:100%" maxlength="100" /></td>
														</tr>
													</table>
												</td>
											</tr>
