...
<script language="javascript">
	...
	function goReceiveList(){
		parent.location.href = "<%=webUri%>/app/index.do?type=receiveMemo";
	}
	
	function goSendList(){
		parent.location.href = "<%=webUri%>/app/index.do?type=sendMemo";
	}
...
<form name="listForm" method='post' action='<%=webUri%>/app/bind/menu.do'>
	...
	<tr onClick="javascript:goNoticeMain();" style="cursor:pointer;">
   		<td height="50" valign="top" background="<%=imagePath%>/left_menu/title_message.jpg"></td>
	</tr>
		...
		<td align="center">
			...
			<tr>
				<td>
              		<table cellspacing="0" cellpadding="0" border="0" width="100%">
                		<tr>
                  			<td group="leftMenuTd" onclick="javascript:goReceiveList();" class="menu_end">
                  				<img id="leftIconBindBox" src="<%=webUri%>/app/ref/image/left_menu/icon_01.gif"> 받은쪽지
                  			</td>
                		</tr>
                		<tr>
                  			<td group="leftMenuTd" onclick="javascript:goSendList();" class="menu_end">
                  				<img id="leftIconBindBox" src="<%=webUri%>/app/ref/image/left_menu/icon_01.gif"> 보낸쪽지
                  			</td>
                		</tr>
              		</table>
              	</td>
