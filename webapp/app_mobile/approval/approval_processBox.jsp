	...
	if(moreFlag != false){
		pageSetting++;
	 	 $.ajax({
				...
				url:'<%=webUri%>/app/list/webservice/approval/ListProgressDocBox.do',
...
function setProcessList(data){
	
	if(pageSetting == 1){
		$("#approvalProcessList").html("");
	}
	
 	if(data.ListVos.length == 0){
		addHtml += "<li class='group'><a href=''>";
		addHtml += "<div class='rf'><p class='title'>진행문서 목록이 없습니다.</p></div></a>";		
	}else{
	...
	$("#approvalProcessList").html(addHtml);
	...
	<div id="wrapper" style="overflow:hidden;">
		<div id="scroller">
			...
			<div class="sub_content app">
				<ul class="list V_Limg_list Rdiv group" id="approvalProcessList">
					<!-- <li class="group">
						<a href="#a">
			...
			<div class="moreNtop">
				<a href="#none" class="more_bottom" onClick="getProcessList();">더보기 <span id="listCount"></span><span>/</span><span id="listTotalCount"></span></a>
