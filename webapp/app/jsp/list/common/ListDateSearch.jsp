...
String[] lob004 = {"searchTitle","list.list.button.searchTypeTitle","searchDrafter","list.list.title.headerDraftReceive"};
			          ...
			          <tr>
			            <td width="455" height="24"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
			              <tr>
			                ...
			                %>
			                <td width="50"><select name="searchType" class="select" <%if("LOB014".equals(resultLobCode)){ %>onchange="javascript:chSearchAudit(this.value);" <% } %>>
			                	<%
			                ...
			                <input name="searchWord" id="searchWord" type="text" class="input" style="width:100%" value="<%=resultSearchWord%>" onkeydown="if(event.keyCode==13){goSearch();}" >
			                </div>
			            ...
			            <td height="24"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			              <tr>			              	
		                	<% if("LOB014".equals(resultLobCode) ) {  %>
				                ...
				                <td class="search_text">
				                	<input type="text" class="input<% if("1".equals(opt342)){ %>_read<% } %>" name="searchWordDeptName" id="searchWordDeptName" style="width:100%" value="<%=resultSearchWordDeptName%>" onkeydown="if(event.keyCode==13){goSearch();}" <% if("1".equals(opt342)){ %> disabled<% } %>>
				                </td>
		                	<% }else{ %>
