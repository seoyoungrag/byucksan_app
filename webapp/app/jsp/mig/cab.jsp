...
function doMig(start, page){
	   $.post(webUri+'/app/cab/mig.do?start='+start+'&page='+page, function(data) {
		   /* $.post('http://smart.bsco.co.kr:81/ep/app/cab/mig.do?start='+start+'&page='+page, function(data) { */
		/* $.post('http://211.168.82.16:8001/ep/app/cab/mig.do?start='+start+'&page='+page, function(data) { */
 		var content = '<tr>' + 
