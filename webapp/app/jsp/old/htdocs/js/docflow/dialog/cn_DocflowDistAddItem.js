...
//		return false;
	...
	var strCharger = getValueById("idCharger");
	if (strCharger == "")
	{
	...
	setRecipGroupDisplayAs(objRecipGroup, "");
	var objRecipient = addRecipient(objRecipGroup);

	setRecipientEnforceBound(objRecipient, "O");
	setRecipientDeptCode(objRecipient, g_strDeptCode);
	setRecipientDeptName(objRecipient, "");
	setRecipientDeptSymbol(objRecipient, "");
	setRecipientDeptChief(objRecipient, "");
	...
	setRecipientActualDeptCode(objRecipient, g_strDeptCode);
