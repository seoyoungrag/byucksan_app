...
function approveMakeRow(tbId, id, lineNum , lineOrder , lineSubOrder ,  approverId , approverName 
	...
	row += "<td width='33%' class='ltb_center' style='border-bottom:  "+tbColor+" 1px solid; '>" + (deptName === "" ? "&nbsp;" : deptName) + "</td>";
	row += "<td width='33%' class='ltb_center' style='border-bottom:  "+tbColor+" 1px solid;border-left:1pt solid  "+tbColor+";border-right:1pt solid  "+tbColor+"; '>" + (positionName === "" ? "&nbsp;" : positionName) + "</td>";
	row += "<td width='34%' class='ltb_center' style='border-bottom:  "+tbColor+" 1px solid;border-right:1pt solid  "+tbColor+"; '>" + (userName === "" ? "&nbsp;" : userName)  + "</td>"
<%
...
function sendOk(){
	...
	msg = opener.getApproverList(appline);
...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" >
		<acube:outerFrame>
			<acube:titleBar>수신자 선택</acube:titleBar>
			<!-- 여백 시작 -->
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
		            <td>
		               <acube:tabGroup>
		                  <acube:tab index="1" onClick="JavaScript:selectTab(1);callMethod('divAppLine');" selected="true">수신자 선택</acube:tab>
						<c:if test='${groupYn == "Y"}'>
						...
						<acube:tableFrame width="100%" border="0" cellpadding="1" cellspacing="0" >
							<tr>
								<td width="100%" height="100%">
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="0">
										<thead>
											<TR><TD width="33%" class="ltb_head" style="border-top:none;border-bottom: <%=tbColor%> 1px solid;"><spring:message code="approval.table.title.sosok" /></TD>
												<TD width="33%"  class="ltb_head"  style='border-left:1pt <%=tbColor%> solid; border-bottom: <%=tbColor %> 1px solid;'><spring:message code="approval.table.title.gikwei" /></TD>
												<TD width="34%"  class="ltb_head"  style='border-left:1pt <%=tbColor%> solid; border-bottom: <%=tbColor %> 1px solid;'><spring:message code="approval.table.title.name" /></TD>
											</TR>
										</thead>
									</table>
									</div>
