...
<title><spring:message code='bind.title.batch.add' /></title>
...
<SCRIPT LANGUAGE="javascript">
	...
	function add() {
		...
		$.ajax({
			url : '<%=webUri%>/app/bind/bindBatchCreate.do',
			type : 'POST',
			dataType : 'json',
			data : {
				unitId : unitId,
...
<acube:titleBar popup="true">
	<spring:message code='bind.title.batch.add' />
</acube:titleBar>
<!-------팝업 타이틀 E --------->

<!-------컨텐츠  S --------->
<acube:outerFrame popup="true">
	<form id="bindForm" name="bindForm" method="POST" action="<%=webUri%>/app/bind/bindBatchCreate.do">
			...
			%>
					...
					<tr bgcolor="#ffffff">
						...
						<table border="0" cellspacing="1" cellpadding="1">
							<tr bgcolor="#ffffff">
								<td><input type="text" class="input" name="bindName" onkeyup="checkInputMaxLength(this, '', 60)" size="49"></td>
							</tr>
						</table>
						</td>
					</tr>
					...
					<tr bgcolor="#ffffff">
						...
						<table border="0" cellspacing="1" cellpadding="1">
							<tr bgcolor="#ffffff">
								<td><input type="text" class="input" name="prefix" onkeyup="checkInputMaxLength(this, '', 36)" size="12"></td>
							</tr>
						</table>
						</td>
					</tr>
