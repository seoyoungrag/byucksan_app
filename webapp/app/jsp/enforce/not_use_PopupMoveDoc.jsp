...
<html>
<head>
<title><spring:message code="approval.enforcemovepopup.title" /></title>
...
<acube:titleBar><spring:message code="approval.enforcemovepopup.title" /></acube:titleBar>
<!-- 여백 시작 -->
...
<% String msg = messageSource.getMessage("approval.enforce.button.move" , null, langType);  %>
